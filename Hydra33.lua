...
function library:New(name) 
	...
	Hydra.Name = "hydrawinnings" 
	Hydra.ResetOnSpawn = false 
	Hydra.ZIndexBehavior = "Global" 
	Hydra.DisplayOrder = 420133769 

	local UIScale = INST("UIScale") 
	UIScale.Parent = Hydra 
	...
	game:GetService("UserInputService").InputBegan:Connect(function(key) 
		if key.KeyCode == Enum.KeyCode.RightShift then 
			Hydra.Enabled = not Hydra.Enabled 
			library.uiopen = Hydra.Enabled 
		end 
	end) 
	...
	do 
		...
		TextLabel.BorderColor3 = COL3RGB(0, 211, 230) 
	...
	function menu:Tab(text) 
		...
		TextButton.MouseButton1Down:Connect(function() 
			if currenttab ~= text then 
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(0, 211, 230)}) 
				currenttab = text 
				TabGui.Visible = true 
			end 
		end) 
		...
		function Tab:MSector(text, side) 
			...
			function MSector:Tab(text) 
				...
				TextButton.MouseButton1Down:Connect(function() 
					...
					tab1.Visible = true 
					library:Tween(TextButton, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(0, 211, 230)}) 
				end) 
				...
				function tab:Element(type, text, data, callback) 
					...
					if type == "Jumbobox" then 
						...
						Drop.ZIndex = 5 
						Drop.ScrollBarImageColor3 = COL3RGB(0, 211, 230) 
							...
							do 
								...
								Button.MouseButton1Down:Connect(function() 
									if TBLFIND(Element.value.Jumbobox, v) then 
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(0, 211, 230)}) 
									end 
									updatetext() 
							...
							for i,v in pairs(Drop:GetChildren()) do 
								if v.Name ~= "UIListLayout" then 
									if TBLFIND(val.Jumbobox, v.Name) then 
										v.TextLabel.TextColor3 = COL3RGB(0, 211, 230)
									else 
					...
					elseif type == "ToggleKeybind" then 
						...
						Color.Name = "Color" 
						Color.Parent = Button 
						Color.BackgroundColor3 = COL3RGB(0, 211, 230)
						...
						local function update() 
							if Element.value.Toggle then 
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(0, 211, 230)}) 
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)}) 
							else 
								keybindremove(text) 
						...
						do 
							...
							Always.Text = "Always" 
							Always.TextColor3 = COL3RGB(0, 211, 230)
							...
							for _,button in pairs(Frame:GetChildren()) do 
								if button:IsA("TextButton") then 
									button.MouseButton1Down:Connect(function() 
										...
										button.TextColor3 = COL3RGB(0, 211, 230) 
										values[tabname][sectorname][tabtext][text] = Element.value 
										callback(Element.value) 
									end) 
									button.MouseEnter:Connect(function() 
										if Element.value.Type ~= button.Text then 
											library:Tween(button, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(0, 211, 230)}) 
										end 
									end) 
									button.MouseLeave:Connect(function() 
										if Element.value.Type ~= button.Text then 
					...
					elseif type == "ToggleColor" then 
						...
						HueFrameGradient.Color = ColorSequence.new { 
							ColorSequenceKeypoint.new(0.00, COL3RGB(0, 211, 230)), 
							...
							ColorSequenceKeypoint.new(0.83, COL3RGB(0, 211, 230)), 
							ColorSequenceKeypoint.new(1.00, COL3RGB(0, 211, 230)) 
						}	 
					...
					elseif type == "ToggleTrans" then 
						...
						TextLabel.Parent = Button 
						TextLabel.BackgroundColor3 = COL3RGB(0, 211, 230) 
						TextLabel.BackgroundTransparency = 1.000 
						TextLabel.Position = UDIM2(0, 32, 0, -1) 
						TextLabel.Size = UDIM2(0.111913361, 208, 1, 0) 
						TextLabel.Font = Enum.Font.Code 
					...
					elseif type == "Slider" then 
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(0, 211, 230)), ColorSequenceKeypoint.new(1, COL3RGB(0, 211, 230))} 
					...
					elseif type == "Button" then 
						...
						Button_2.MouseButton1Down:Connect(function() 
							TextLabel.TextColor3 = COL3RGB(0, 211, 230)
						...
						Button_2.MouseEnter:Connect(function() 
							library:Tween(TextLabel, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(0, 211, 230)}) 
						end) 
			...
			function Sector:Element(type, text, data, callback) 
				...
				if type == "ScrollDrop" then 
					...
					for i,v in ipairs(joe) do 
						do 
							...
							Frame.ScrollBarImageColor3 = COL3RGB(0, 211, 230)      
								...
								for _,bad in pairs(v.Frame:GetChildren()) do      
									if bad:IsA("TextButton") then      
										...
										if bad.Name == Element.value.Scroll[v.Name] then      
											bad.TextLabel.TextColor3 = COL3RGB(0, 211, 230)     
										end      
									end      
								end      
							end      
				...
				elseif type == "Scroll" then      
					...
					function Element:SetValue(val)      
						...
						library:Tween(Frame[Element.value.Scroll].TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(0, 211, 230)})      
						values[tabname][sectorname][text] = Element.value      
						callback(Element.value)      
					end      
					values[tabname][sectorname][text] = Element.value      
...
local ChrModels = game:GetObjects("rbxassetid://8198238835")[1] 
...
for _,lua in pairs(listfiles("hydralua")) do 
	local luaname = GSUB(lua, "hydralua\\", "") 
	INSERT(allluas, luaname) 
end 

RunService.RenderStepped:Wait() 

local gui = library:New("Hydra.pw") 
...
luascripts:Element("Button", "load", {}, function() 
	loadstring(readfile("hydralua\\"..values.luas["lua scripts"].lua.Scroll))() 
end) 
...
chat:Element("Toggle", "chat spam", nil, function(tbl) 
	if tbl.Toggle then 
		while values.misc.chat["chat spam"].Toggle do 
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "gg" and "gg" or "I hope you know CPR, because you just took my breath away! So, aside from taking my breath away, what do you do for a living? I ought to complain to Spotify for you not being named this week’s hottest single. Are you a parking ticket? ‘Cause you’ve got ‘fine’ written all over you. Your eyes are like the ocean; I could swim in them all day. When I look in your eyes, I see a very kind soul. If you were a vegetable, you’d be a ‘cute-cumber.’ Do you happen to have a Band-Aid? ‘Cause I scraped my knees falling for you. I never believed in love at first sight, but that was before I saw you. I didn’t know what I wanted in a woman until I saw you. I was wondering if you could tell me: If you’re here, who’s running Heaven? No wonder the sky is gray (or dark, if at night)—all the color is in your eyes. You’