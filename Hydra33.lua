...
Title = "Hydra"; -- 
Text = "Thank you for using Hydra!"; -- 
...
--Made by GiftedXI#2898 and Coded by 𝐻𝒶𝓂𝓅𝑒#0706, Leaked by VierreTree#9401 and ᴀᴠɴᴜʟ#5118
...
local MainUIColor = COL3RGB(0, 211, 230)    
...
function library:New(name)      
    ...
    cursor.ZIndex = 1000      
    cursor.ImageColor3 = COL3RGB(0,0,255)      
    ...
    Menu.Image = "http://www.roblox.com/asset/?id=8132927703"      
                    ...
                    if type == "Jumbobox" then      
                        ...
                        for i,v in ipairs(data.options) do      
                            do      
                                ...
                                Button.Name = v      
                                Button.Parent = Drop      
                                Button.BackgroundColor3 = COL3RGB(0, 211, 230)      
                                Button.BorderColor3 = COL3RGB(27, 27, 35)      
                                Button.Position = UDIM2(0, 30, 0, 16)      
                                Button.Size = UDIM2(0, 175, 0, 17)      
                                Button.AutoButtonColor = false      
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 211, 230)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 115, 115))}
...
aimbot:Element("Dropdown", "prediction type", {options = {"off", "Stormy.Hydra", "bloxsense.gay", "ova.rocks", "nixus"}})          
...
aimbot:Element("Dropdown", "autoshoot type", {options = {"Hydra" ,"standard", "off"}})
aimbot:Element("Dropdown", "autowall type", {options = {"Hydra", "standard", "off"}})
...
local function AddRage(Tab)      
    ...
    Tab:Element("Slider", "minimum damage", {min = -99999999, max = 100, default = 20})      
...
antiaim:Element("Dropdown", "pitch", {options = {"None", "Up", "Down","Huge", "Custom", "Zero", "180", "Random AA", "Stormy.Hydra", "God", "Sus_down", "wtf", "glitch", "sussy", "fucker"}})   
...
effects:Element("Toggle", "shadowmap Hydranology", nil, function(val) sethiddenproperty(Lighting, "Hydranology", val.Toggle and "ShadowMap" or "Legacy") end)      
...
chat:Element("Toggle", "chat spam", nil, function(tbl)      
    if tbl.Toggle then      
        while values.misc.chat["chat spam"].Toggle do      
            game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "Winning" and "Join the winning team! Stormy.Hydranology v4!!" or values.misc.chat.type.Dropdown == "Stormy.Hydra" and "$$$ Im Using Stormy.Hydra $$$" or values.misc.chat.type.Dropdown == "MOM" and "I FUCKED UR MOM NIGGA I FUCKED UR MOM NIGGA I FUCKED UR MOM NIGGA" or values.misc.chat.type.Dropdown == "SEMI" and "🐀 RATTED BY SEMI  🐀 ❌ DONT FUCK ❌ WITH 👾BLOXSENSE 👾👨‍🦲USERS👨‍🦲", false, "Innocent", false, true) 
            wait(values.misc.chat["speed (ms)"].Slider/1000)      
                
        end      
    end      
end)      
chat:Element("Dropdown", "type", {options = {"Winning", "Stormy.Hydra", "MOM", "SEMI"}}) 
...
ChatScript.createNewMessage("Hydra","Stormy.Hydra is Successfully 100% Loaded",MainUIColor,Color3.new(1,1,1),0.01,nil)
ChatScript.moveOldMessages()
ChatScript.createNewMessage("Hydra","Thank you for Using Stormy.Hydra v2! :D",MainUIColor,Color3.new(1,1,1),0.01,nil)
ChatScript.moveOldMessages()
ChatScript.createNewMessage("Hydra","Version 1.3.9",MainUIColor,Color3.new(1,1,1),0.01,nil)
ChatScript.moveOldMessages()
ChatScript.createNewMessage("Hydra","Credits to Rainy.solution, Mexican Hook, LunarSense, Bloxity.tk/Pepsi/Astolfo, For Giving me Permissions to make this paste.",MainUIColor,Color3.new(1,1,1),0.01,nil)
Print("Hello Private Users :D")